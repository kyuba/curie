...
ICEMAKE_FILES="icemake icemake-build icemake-install icemake-run-tests icemake-link icemake-crosslink icemake-post-process sexpr memory memory-pool memory-allocator io string io-system sexpr-read-write sexpr-library tree immutable multiplex multiplex-signal multiplex-process multiplex-io multiplex-system signal-system exec exec-system network network-system multiplex-sexpr"

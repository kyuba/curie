...
SET ICEMAKE_FILES=icemake icemake-build icemake-install icemake-link icemake-tc-gcc icemake-tc-borland icemake-tc-msvc icemake-stubs sexpr memory memory-pool memory-allocator io string io-system sexpr-read-write sexpr-library tree-basic immutable multiplex multiplex-signal multiplex-process multiplex-io multiplex-system signal-system exec exec-system network network-system multiplex-sexpr filesystem sexpr-stdio stdio utf-8 sexpr-custom hash tree-string tree-library gcd variables libc-compat io-pool sexpr-set bootstrap shell
SET OBJECTS=
...
build\b-icemake.exe %* curie-bootstrap syscall curie sievert icemake ice
